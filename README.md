...
Pre-built binaries are available here: [release](https://github.com/BROBIRD/clash/releases)  
Pre-built TUN mode binaries are available here: [TUN release](https://github.com/BROBIRD/clash/releases/tag/TUN). Source is not currently available.
...
If you have Docker installed, it's recommended to deploy Clash directly using `docker-compose`: [run Clash in Docker](https://github.com/BROBIRD/clash/wiki/Run-clash-in-docker)
