...
#
# Build:
#   - git clone -b dev https://github.com/fengyie007/clash
#   - cd clash
...
go build -ldflags "-X \"github.com/fengyie007/clash/constant.Version=$VERSION\" -X \"github.com/fengyie007/clash/constant.BuildTime=$BUILDTIME\" -w -s" \
